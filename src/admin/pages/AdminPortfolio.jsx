              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 bg-white">
                    <th className="px-3 py-3 lg:px-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">#</th>
                    <th className="px-3 py-3 lg:px-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">ID</th>
                    <th className="px-3 py-3 lg:px-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Project Profile</th>
                    <th className="px-3 py-3 lg:px-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Category</th>
                    <th className="px-3 py-3 lg:px-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Client / Details</th>
                    <th className="px-3 py-3 lg:px-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Status</th>
                    <th className="px-3 py-3 lg:px-4 text-[11px] font-bold text-slate-400 uppercase tracking-wider text-right">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  {filteredItems.map((item, idx) => (
                    <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      {/* Index */}
                      <td className="px-3 py-3 lg:px-4 text-xs font-semibold text-slate-400">
                        {idx + 1}
                      </td>

                      {/* ID */}
                      <td className="px-3 py-3 lg:px-4 text-xs font-mono font-bold text-slate-700">
                      ...
                      {/* Client / Details */}
                      <td className="px-3 py-3 lg:px-4 text-xs text-slate-600 font-medium">
